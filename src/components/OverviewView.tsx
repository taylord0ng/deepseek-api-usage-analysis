...
export default function OverviewView() {
 ...
 <h3 className="text-sm font-semibold text-gray-600 mb-3">{t.overview.dailyCost}</h3>
 <ReactECharts option={dailyOption} style={{ height: 280 }} />
 </div>
 <div className="bg-white border border-gray-200 rounded-lg p-4">
 <h3 className="text-sm font-semibold text-gray-600 mb-3">{t.overview.costByKey}</h3>
