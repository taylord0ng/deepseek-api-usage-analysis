...
**Version**: 0.6.4
- **New in this version**: Author & Team page revamp with 4-member profiles, Tencent Cloud affiliate integration, blog article pricing data refreshed with latest GPT/Claude models, URL canonicalization fix for blog comparison article
...
│   ├── ChangelogPage.tsx      # Changelog page: complete version history (v0.1.0–v0.6.4), entries by category (Added/Improved/Fixed/Dependencies) with color-coded dots, JSON-LD WebPage schema, bilingual, Apple-minimalist legal-text layout matching privacy/terms pages
...
- **`/changelog`** (`ChangelogPage.tsx`): Complete version history from v0.1.0 to v0.6.4, entries organized by category (Added/Improved/Fixed/Dependencies) with color-coded dots, JSON-LD WebPage schema, bilingual, Apple-minimalist legal-text layout matching privacy/terms pages. Priority 0.5 in sitemap.
